...
DEMO_TENDERS_SEED: List[Dict[str, Any]] = [
    {
        ...
        "bid_type": "2-Cover Open Technical Bid",
    ...
    },
    {
        ...
        "bid_type": "Global Tender Enquiry (Make in India Class-1)",
    ...
    },
    {
        ...
        "estimated_value_cr": 42.00,
        "bid_type": "2-Cover Reverse Auction EPC",
...
def generate_bidders_for_tender(tender_id: str) -> List[Dict[str, Any]]:
    ...
    if tender_id == "GEM/2026/B/89420":
        ...
        configs = [
            ...
            ("BID-2026-0109", "Vanguard Defense & Engineering Works", "Private Limited", "Delhi", "Plot 12, Phase-II, Okhla Ind Area, Delhi", "SBIN0004921", 3, "HARD_FAIL_DEBARRED_VENDOR", 385, 85000000.0, "Vikram Malhotra", "01928374", "07AAACV7788P1Z8", "AAACV7788P", "UDYAM-DL-02-0056123"),
            ("BID-2026-0112", "Param Quantum Computing Systems Ltd", "Public Limited", "Karnataka", "Electronic City Phase 1, Bangalore", "ICIC0001092", 0, "COMPLIANT_MODEL_BIDDER", 882, 120000000.0, "Dr. Anand Rao", "02918234", "29AAACP5544R1Z1", "AAACP5544R", "UDYAM-KR-03-0044192"),
            ...
            ("BID-2026-0121", "Vayu Networks & Server Grid Pvt Ltd", "Private Limited", "Tamil Nadu", "Tidel Park, OMR, Chennai", "BARB0OMRCHE", 0, "COMPLIANT_MODEL_BIDDER", 820, 62000000.0, "K. Swaminathan", "04719283", "33AAACV3399J1Z7", "AAACV3399J", "UDYAM-TN-02-0067189"),
            ...
            ("BID-2026-0130", "Raksha Cyber Labs Private Limited", "Private Limited", "Delhi", "Plot 14, Phase-II, Okhla Ind Area, Delhi", "SBIN0004921", 2, "HARD_FAIL_DEBARRED_VENDOR", 410, 42000000.0, "Rohan Malhotra", "08192833", "07AAACR9988C1Z0", "AAACR9988C", "UDYAM-DL-02-0044192"),
            ...
            ("BID-2026-0139", "Surya Defense Telematics", "Partnership", "Madhya Pradesh", "Pithampur Industrial Area, Indore", "BKID0004491", 0, "COMPLIANT_MODEL_BIDDER", 810, 31000000.0, "Harish Chawla", "04192837", "23AAAFS9900H1Z3", "AAAFS9900H", "UDYAM-MP-09-0011823"),
            ("BID-2026-0142", "Pragati IT Infrastructure Solutions", "Private Limited", "West Bengal", "Salt Lake Sector V, Kolkata", "UBIN0532819", 0, "COMPLIANT_MODEL_BIDDER", 860, 58000000.0, "Subrata Sen", "02198274", "19AAACP4433D1Z1", "AAACP4433D", "UDYAM-WB-05-0088192"),
        ...
        # Healthcare AIIMS Tender Bidders
        configs = [
            ...
            ("BID-2026-0204", "Dhanvantari Bio-Imaging Solutions Ltd", "Public Limited", "Karnataka", "Whitefield, Bangalore", "HDFC0004812", 0, "COMPLIANT_MODEL_BIDDER", 890, 340000000.0, "Ramesh Narayan", "02819283", "29AAACD9988B1Z7", "AAACD9988B", "UDYAM-KR-03-0099182"),
            ...
            ("BID-2026-0213", "Lifeline Healthcare Robotics", "Private Limited", "Telangana", "Gachibowli, Hyderabad", "KKBK0001928", 0, "COMPLIANT_MODEL_BIDDER", 830, 145000000.0, "Naveen Prasad", "05192834", "36AAACL8899E1Z2", "AAACL8899E", "UDYAM-TS-08-0077192"),
            ("BID-2026-0216", "Medico Global Supply Chain Pvt Ltd", "Private Limited", "Delhi", "Patparganj Industrial Area, Delhi", "SBIN0008819", 2, "HARD_FAIL_DEBARRED_VENDOR", 360, 48000000.0, "Rajender Aggarwal", "06192837", "07AAACM3322F1Z8", "AAACM3322F", "UDYAM-DL-04-0011823"),
            ...
            ("BID-2026-0225", "Pulse Biomedical Technologies Pvt Ltd", "Private Limited", "Uttar Pradesh", "Sector 59, Noida", "PUNB0019283", 0, "COMPLIANT_MODEL_BIDDER", 780, 72000000.0, "Vipin Mathur", "09182734", "09AAACP6655I1Z0", "AAACP6655I", "UDYAM-UP-12-0044192"),
            ...
            ("BID-2026-0231", "CureTech Surgical & Radiography", "Private Limited", "Haryana", "Udyog Vihar, Gurugram", "ICIC0001829", 0, "DOCUMENT_MISMATCH_SUSPICIOUS", 740, 110000000.0, "Pankaj Sethi", "02819273", "06AAACC8877K1Z4", "AAACC8877K", "UDYAM-HR-04-0088192"),
            ("BID-2026-0234", "BioShield Labs & Diagnostics", "Private Limited", "Delhi", "Okhla Industrial Area Phase-1, Delhi", "SBIN0004921", 2, "HARD_FAIL_DEBARRED_VENDOR", 390, 39000000.0, "Sanjay Mittal", "03719283", "07AAACB5544L1Z2", "AAACB5544L", "UDYAM-DL-02-0033182"),
            ("BID-2026-0237", "Zenith Medical Instrumentation Ltd", "Public Limited", "Karnataka", "Peenya Industrial Area, Bangalore", "KKBK0008819", 0, "COMPLIANT_MODEL_BIDDER", 880, 290000000.0, "K. R. Murthy", "04819201", "29AAACZ1199M1Z9", "AAACZ1199M", "UDYAM-KR-03-0077192"),
        ...
        # EV Clean Energy Tender Bidders
        configs = [
            ...
            ("BID-2026-0304", "Gati Green Mobility Innovations Ltd", "Public Limited", "Tamil Nadu", "Sriperumbudur, Chennai", "HDFC0001928", 0, "COMPLIANT_MODEL_BIDDER", 870, 620000000.0, "M. Balakrishnan", "02918234", "33AAACG9988R1Z2", "AAACG9988R", "UDYAM-TN-02-0044819"),
            ...
            ("BID-2026-0313", "Prakriti Clean Transport Infrastructure", "Private Limited", "Haryana", "Manesar Industrial Township, Gurugram", "KKBK0001829", 0, "COMPLIANT_MODEL_BIDDER", 815, 160000000.0, "Abhay Singhania", "05819283", "06AAACP8899U1Z1", "AAACP8899U", "UDYAM-HR-04-0033192"),
            ("BID-2026-0316", "AutoTech Fleet Assemblies Pvt Ltd", "Private Limited", "Delhi", "Badli Industrial Estate, Delhi", "SBIN0008812", 2, "HARD_FAIL_DEBARRED_VENDOR", 370, 78000000.0, "Devendra Juneja", "06918273", "07AAACA3322V1Z7", "AAACA3322V", "UDYAM-DL-05-0099182"),
            ...
            ("BID-2026-0322", "ChargePoint Bharat Superchargers Ltd", "Public Limited", "Maharashtra", "Thane Belapur Road, Navi Mumbai", "UBIN0518293", 0, "COMPLIANT_MODEL_BIDDER", 790, 140000000.0, "Sanjay Vaze", "08918274", "27AAACC2233X1Z0", "AAACC2233X", "UDYAM-MH-33-0044182"),
            ...
            ("BID-2026-0334", "MetroVolt Commercial Vehicles", "Private Limited", "Delhi", "Okhla Industrial Area Phase-3, Delhi", "SBIN0004921", 2, "HARD_FAIL_DEBARRED_VENDOR", 420, 69000000.0, "Siddharth Malhotra", "03819284", "07AAACM5544B1Z5", "AAACM5544B", "UDYAM-DL-02-0088182"),
            ...
            ("BID-2026-0340", "Pragati Clean Energy Infra Pvt Ltd", "Private Limited", "West Bengal", "Durgapur Industrial Corridor, Burdwan", "ANDB0008819", 0, "COMPLIANT_MODEL_BIDDER", 820, 115000000.0, "Arindam Mukherjee", "05819201", "19AAACP7766D1Z9", "AAACP7766D", "UDYAM-WB-06-0044182"),
